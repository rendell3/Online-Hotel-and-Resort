...
<div class="row" style="margin-top:20vh; margin-bottom:10vh;">
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="text-center m-b-20">
            <div class="m-b-20">
                <div class="checkmark">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <circle class="path" fill="none" stroke="#32c861" stroke-width="4" stroke-miterlimit="10" cx="80.6"
                            cy="80.6" r="62.1" />
            ...
            <p class="text-muted font-14 m-t-10"> You are now successfully logged out.<br>Back to <a href="?page=home"
                    class="text-dark"><b>Home</b></a></p>
        </div>
    </div>
</div>